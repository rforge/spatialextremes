...
\begin{eqnarray*}
  ...
  dD_{z_1} &=& \frac{\partial D}{\partial z_1} = \frac{(1 - c_2^2)
      \varphi(c_1)}{a^2 z_1^3 z_2} - \frac{\left[1 +
...
\begin{eqnarray*}
  ...
  \frac{(a+c_1)\varphi(c_1)}{a^2z_1z_2^2}\\
  ...
  \frac{(1 - c_1^2) \varphi(c_2)}{a^3z_1z_2^3}
\end{eqnarray*}
