...
% \VignetteKeyword{Spatial Extremes}
% \VignetteKeyword{Max-stable processes}
...
<<label=covariances,echo=FALSE,fig.keep='none'>>=
...
<<label=anisoCovFun,echo=FALSE,fig.keep='none'>>=
...
<<label=extCoeffModels,echo=FALSE,fig.keep='none'>>=
...
<<label=extCoeffST-Smith,echo=FALSE,fig.keep='none'>>=
n.site <- 40
n.obs <- 100
coord <- matrix(runif(2 * n.site, 0, 10), ncol = 2)
...
<<echo=FALSE,label=madogram,fig.keep='none'>>=
...
<<label=madogramExtCoeff,echo=FALSE,fig.keep='none'>>=
n.site <- 40
n.obs <- 100
coord <- matrix(runif(2 * n.site, 0, 10), ncol = 2)
data <- rmaxstab(n.obs, coord, "whitmat", nugget = 0, range = 1, smooth = 1)
...
<<echo=FALSE,label=F-madogram,fig.keep='none'>>=
n.site <- 40
n.obs <- 100
coord <- matrix(runif(2 * n.site, 0, 10), ncol = 2)
...
<<label=lambda-madogram,echo=FALSE,fig.keep='none'>>=
n.site <- 40
n.obs <- 100
coord <- matrix(runif(2 * n.site, 0, 10), ncol = 2)
...
<<label=knotsEffect,echo=FALSE,fig.keep='none'>>=
set.seed(12)
x <- runif(100)
...
<<label=smoothingParamEffect,echo=FALSE,fig.keep='none'>>=
...
<<label=CVandGCV,echo=FALSE,fig.keep='none'>>=
par(mfrow=c(1,3))
