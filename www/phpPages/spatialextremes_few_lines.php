...
<div class="Rcodes">
  ...
  <a href="#Smith" class="Routs">
    <code class="Routs"> fitmaxstab(data, coord, "gauss", fit.marge = FALSE) </code>
    <span class="Rcomments">
  ...
  <a href="#Powexp" class="Routs">
    <code class="Routs">fitmaxstab(data, corrd, "powexp", fit.marge = FALSE)</code>
    <span class="Rcomments">
...
<div class="Rcodes">
  ...
  <a href="images/madogram.png" rel="lightbox" title="Madogram" class="Routs">
    <code class="Routs">madogram(data, coord, which = "mado")</code>
    <span>
  ...
  <a class="Routs" rel="lightbox" title="Extremal coefficient" href="images/fitextcoeff.png">
    <code class="Routs">fitextcoeff(data, coord); fitextcoeff(data, coord, angles =
  ...
  <a class="Routs" rel="lightbox" title="Profile composite likelihood"
    ...
    <code class="Routs">profile(fitted.object, "cov11", range = c(80, 200))</code>
    <span>
