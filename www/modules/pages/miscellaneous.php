<?php $nav_en_cours = 'learnmore'; $title = 'Other tools'?>
<?php include("modules/pages/menuLearnMore.php"); ?>
<div id="right">
  <div id="right_top"></div>
  <div id="right_bg">
    Although the SpatialExtremes package aims at providing statistical
    model for the modelling of spatial extremes, several features are
    available.
    <ul>
